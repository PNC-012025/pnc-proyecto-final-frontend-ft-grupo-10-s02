...
const DepositTable = () => {
	...
	useEffect(() => {
		if (showDepositPopup && accounts.length > 0) {
			...
			setSelectedAccountId(accounts[0].id); // Por defecto la primera cuenta
		}
		...
		},
		{
			...
			cell: (row: User) => (
				<div className="flex items-center justify-center space-x-2">
					<button
						className="p-3 rounded-xl bg-green-100 hover:bg-green-200 text-green-600 transition flex items-center justify-center"
				...
				<div className="flex mt-4 md:mt-0 space-x-3">
					<div className="relative">
						...
						<div className="absolute left-3 top-3 text-gray-400">
							{/* Aquí puedes poner un ícono de búsqueda si quieres */}
						</div>
					</div>
				</div>
			</div>
